...
\inthenotessubproblem{Derive the PDF of $R = \frac{\Xbar - \mu}{\frac{S}{\sqrt{n}}}$ from scratch.}\spc{18}
...
\intermediatesubproblem{Put it all together: what is the distribution of $S^2$?}\spc{3}
