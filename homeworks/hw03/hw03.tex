...
\intermediatesubproblem{Correlation $\rho$ is a normalized unitless covariance metric. It is defined for for any two non-degenerate rv's $X_1$ and $X_2$ as:

\beqn
\rho_{1,2} := \corr{X_1,\,X_2} := \frac{\sigma_{1,2}}{\sigma_1 \sigma_2} = \frac{\cov{X_1}{X_2}}{\sqrt{\var{X_1} \var{X_2}}}.
\eeqn

Prove that $\rho \in \bracks{-1, 1}$ for any two non-degenerate rv's $X_1$ and $X_2$.}\spc{4}
